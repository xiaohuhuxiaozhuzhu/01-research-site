...
- Content release readiness: `scripts/render_content_release_readiness.py`, `docs/content-release-readiness.md`, and `output/content_release_readiness.md` connect all 28 briefs to source, author, limitation, bilingual, GSC, and GEO gates; every brief remains human-review-only.
