...
const required = ['index.html', 'digest.html', 'methodology.html', 'tools.html', 'politics.html', 'agent.html', 'references.html', 'explorer.html', 'compare.html', 'case-studies.html', 'styles.css', 'data/digests.json', 'robots.txt', 'sitemap.xml', 'llms.txt'];
