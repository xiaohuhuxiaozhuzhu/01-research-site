...
const pages = ['index.html', 'digest.html', 'methodology.html', 'tools.html', 'agenda.html', 'politics.html', 'agent.html', 'references.html', 'explorer.html', 'compare.html', 'case-studies.html', 'case-study-literature.html', 'case-study-evidence.html', 'case-study-governance.html', 'case-study-bilingual.html', 'case-study-human-review.html', 'portfolio-evidence.html', 'pm-interview.html', 'ops-playbook.html'];
const errors = [];
